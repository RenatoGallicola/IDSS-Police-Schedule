...
# Load the dataset
    ...
    num_lat_intervals = 30  # You can adjust this value based on the distribution
    num_lon_intervals = 30  # You can adjust this value based on the distribution
