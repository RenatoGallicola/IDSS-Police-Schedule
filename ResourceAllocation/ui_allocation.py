...
class UIAllocation:
    def __init__(
        ...
        self.__policeman_data = self.__get_policeman_data()
        self.__hour = hour
        self.__day = day
        self.__month = month
        self.__year = year
    ...
    def __location_requirements(self):
        model_result = self.__p_class.predict(self.__hour, self.__day, self.__month, self.__year)
    ...
    def allocate(self):
        ...
        dest, _ = ap(loc_dist, loc_req, tol, margin)
        return dest
